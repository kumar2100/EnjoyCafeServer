...
<script type="text/javascript">
            ...
            function cancelEdit(id) {
                var f = document.add_form1;
                f.method = "post";
                f.action = 'admin_pay_cash_total_list_items.jsp?id='+id;
                f.submit();
            }
            ...
            function sum() {
            	...
            	var txtFirstNumberValue = document.add_form1.item_quantity.value;
                var txtSecondNumberValue = document.add_form1.item_cost_per_unit.value;

                var result = parseInt(txtFirstNumberValue) * parseInt(txtSecondNumberValue);
             
                    if (!isNaN(result)) {
                        //document.getElementById('txt3').value = result;
                        document.add_form1.item_amount.value = result;
                     }
            }           
...
<BODY>
	<FORM name="add_form1" action="admin_item_add_salesV2.jsp"
		...
		<div align="center">
			<TABLE border="1">
				...
				<tr>
					...
					<td bgcolor="#ffffb9"><input type="text" onkeyup="sum();" name="item_quantity"></td>
				</tr>
				<tr>
		...
		<%
			...
			if (work_id != null && item_details != null) {
				if (work_id != "" && item_details != "") {
					try {
						...
						pstatement.setInt(1, Integer.parseInt(work_id));
						pstatement.setString(2, item_details);
						pstatement.setInt(3,
								Integer.parseInt(item_cost_per_unit));
						pstatement.setString(4, item_quantity);
						pstatement.setInt(5, Integer.parseInt(item_amount));
						pstatement.setString(6, item_brand);
						pstatement.setString(7, "SOLD");
