        ...
        <form name ="form1" method="get" action="admin_add_sales.jsp">
            <table border=2 cellpadding=5 width="100%">
                ...
                <tr>
                    ...
                    <td align="center" bgcolor="#ffffb9"><font size="2" face="verdana" color="800040"><%=jbill_id%></td>
                ...
                <tr>
                    ...
                    <input type="hidden" name="bill_id" value="<%=jbill_id%>">
 
                <td bgcolor="#ffddff"><input type="button" name="addSales" value="Add Sales" onclick="addSalesWithBill(<%=jbill_id%>);"></td>
                <td bgcolor="#ffddff"><input type="button" name="addSales" value="Add Sales Direct" onclick="admin_add_sales.jsp?bill_id=" +pbill_id"+"&work_id="+pworkid"></td>
                <td> <a href="/EnjoyCafeServer/jsp/admin_item_add_sales.jsp?bill_id=<%=jbill_id%>&work_id=<%=jwork_id%>">Add Sales</a></td>
